...
<head>
    ...
    <title>JWT |
        <?= $data["datiUtente"]->first_name . " " . $data["datiUtente"]->last_name ?>
    </title>
</head>
        ...
        <div class="w-4/5 flex flex-col items-center">
            <div class="w-full items-center mt-20">
                <div class="justify-center items-center text-center">
                    <h1 class="text-2xl mb-2">Good morning,
                        <?= $data["datiUtente"]->first_name ?>
                    </h1>
            ...
            <div class="my-10 flex w-3/4 max-w-5xl flex-col rounded-xl bg-white shadow-lg">
                <table class="w-full">
                <thead>
                    <tr
