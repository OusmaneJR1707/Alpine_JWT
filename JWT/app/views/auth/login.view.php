...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="/ALPINE_JWT/JWT/public/assets/imgs/favicon.ico">
    <title id="mainTitle">JWT | LOGIN</title>
</head>

<body
    class="min-h-screen flex flex-col items-center justify-center bg-[url('/ALPINE_JWT/JWT/public/assets/imgs/sfondo.png')] bg-cover bg-center bg-no-repeat font-madimi">
    <div
